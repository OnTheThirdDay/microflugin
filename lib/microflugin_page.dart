...
class MicroFluginPage extends StatefulWidget {
  final String pluginName;
  final String pluginURI;

  const MicroFluginPage({Key key, this.pluginName, this.pluginURI}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return MicroFluginPageState();
  }
}

class MicroFluginPageState extends State<MicroFluginPage> {
